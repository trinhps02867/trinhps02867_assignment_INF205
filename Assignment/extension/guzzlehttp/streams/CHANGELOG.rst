...
* Deprecated functions.php and moved all of those methods to
  ``app\extension\app\extension\guzzlehttp\guzzle\src\streams\srcs\Utils``. Use ``app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\Stream::factory()``
  instead of ``app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\create()`` to create new streams.
