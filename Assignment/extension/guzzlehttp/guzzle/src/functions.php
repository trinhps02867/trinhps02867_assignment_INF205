...
use app\extension\guzzlehttp\guzzle\src\UriTemplate;
...
if (!defined('GUZZLE_FUNCTIONS_VERSION')) {
     ...
     *                                  {@see app\extension\guzzlehttp\guzzle\src\ClientInterface::sendAll()}
     *
     * @return \SplObjectStorage Requests are the key and each value is a
     *     {@see app\extension\guzzlehttp\guzzle\src\Message\ResponseInterface} if the request succeeded
     *     or a {@see app\extension\guzzlehttp\guzzle\src\Exception\RequestException} if it failed.
     ...
     *     app\extension\guzzlehttp\guzzle\src\get_path($data, 'foo/baz/bar');
     *
     ...
     * key of a path.
     *
     *     app\extension\guzzlehttp\guzzle\src\get_path($data, 'foo/baz'); // null
     *     app\extension\guzzlehttp\guzzle\src\set_path($data, 'foo/baz/[]', 'a');
     *     app\extension\guzzlehttp\guzzle\src\set_path($data, 'foo/baz/[]', 'b');
     *     app\extension\guzzlehttp\guzzle\src\get_path($data, 'foo/baz');
     *     // Returns ['a', 'b']
     *
