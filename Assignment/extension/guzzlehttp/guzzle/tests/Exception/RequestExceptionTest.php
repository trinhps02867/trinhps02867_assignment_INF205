...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Exception\RequestException
 */
class RequestExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreatesGenerateException()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Exception\RequestException', $e);
    }
    ...
    public function testCreatesClientErrorResponseException()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Exception\ClientException', $e);
    }
    ...
    public function testCreatesServerErrorResponseException()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Exception\ServerException', $e);
    }
