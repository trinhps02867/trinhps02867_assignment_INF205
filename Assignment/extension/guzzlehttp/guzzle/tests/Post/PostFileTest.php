...
namespace app\extension\guzzlehttp\guzzle\src\Tests\Post;
...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Post\PostFile
 */
class PostFileTest extends \PHPUnit_Framework_TestCase
{
    public function testCreatesFromString()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Post\PostFileInterface', $p);
    ...
    {
        $mp = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Post\MultipartBody')
