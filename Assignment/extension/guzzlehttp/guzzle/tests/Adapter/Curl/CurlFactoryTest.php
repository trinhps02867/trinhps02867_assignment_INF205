...
namespace app\extension\guzzlehttp\guzzle\src\Adapter\Curl
{
...
namespace app\extension\guzzlehttp\guzzle\src\Tests\Adapter\Curl {
    ...
    use app\extension\guzzlehttp\guzzle\src\Adapter\Curl\CurlFactory;
    ...
    use app\extension\guzzlehttp\guzzle\src\Exception\ServerException;
    ...
    /**
     * @covers app\extension\guzzlehttp\guzzle\src\Adapter\Curl\CurlFactory
     */
    class CurlFactoryTest extends \PHPUnit_Framework_TestCase
    {
        /** @var \app\extension\guzzlehttp\guzzle\src\Tests\Server */
        static $server;
        ...
        public function testCreatesCurlHandle()
        {
            ...
            $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Message\ResponseInterface', $response);
        ...
        {
            $stream = $this->getMockBuilder('app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\Stream')
        ...
        /**
         * @expectedException \app\extension\guzzlehttp\guzzle\src\Exception\AdapterException
         */
