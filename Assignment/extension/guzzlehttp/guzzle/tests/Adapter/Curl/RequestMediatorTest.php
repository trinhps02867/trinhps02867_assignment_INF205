...
use app\extension\guzzlehttp\guzzle\src\Adapter\Curl\RequestMediator;
...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Adapter\Curl\RequestMediator
 */
class RequestMediatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEmitsHeadersEventForHeadRequest()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\\Event\\HeadersEvent', $ee);
    }
}
