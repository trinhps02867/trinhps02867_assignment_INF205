...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Adapter\Curl\MultiAdapter
 */
class MultiAdapterTest extends AbstractCurl
{
    ...
    public function testChecksForCurlException()
    {
        ...
        $transaction = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Adapter\Transaction')
        ...
        $context = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Adapter\Curl\BatchContext')
