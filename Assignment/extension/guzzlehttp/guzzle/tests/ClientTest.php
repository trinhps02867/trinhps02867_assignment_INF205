...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Client
 */
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testClientUsesDefaultAdapterWhenNoneIsSet()
    {
        ...
        if (!extension_loaded('curl')) {
            $adapter = 'app\extension\guzzlehttp\guzzle\src\Adapter\StreamAdapter';
        } elseif (ini_get('allow_url_fopen')) {
            $adapter = 'app\extension\guzzlehttp\guzzle\src\Adapter\StreamingProxyAdapter';
        } else {
            $adapter = 'app\extension\guzzlehttp\guzzle\src\Adapter\Curl\CurlAdapter';
        }
    ...
    {
        $adapter = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Adapter\AdapterInterface')
            ->setMethods(['send'])
    ...
    {
        $factory = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Message\MessageFactoryInterface')
    ...
    {
        $emitter = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Event\EmitterInterface')
    ...
    {
        $client = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Client')
            ->setMethods(['send'])
            ->getMock();
    ...
    {
        $f = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Message\MessageFactoryInterface')
    ...
    {
        $adapter = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Adapter\MockAdapter')
            ->setMethods(['send'])
            ->getMock();
        $adapter->expects($this->once())
            ->method('send');
