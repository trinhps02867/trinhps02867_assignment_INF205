...
use app\extension\guzzlehttp\guzzle\src\Subscriber\Prepare;

/**
 * @covers app\extension\guzzlehttp\guzzle\src\Subscriber\Prepare
 */
class PrepareTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAppliesPostBody()
    {
        $s = new Prepare();
        $t = $this->getTrans();
        $p = $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Post\PostBody')
    ...
    /**
     * @return \app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\StreamInterface
     */
    private function getMockBody()
    {
        $s = $this->getMockBuilder('app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\MetadataStreamInterface')
