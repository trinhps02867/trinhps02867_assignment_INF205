...
use app\extension\guzzlehttp\guzzle\src\Event\Emitter;
use app\extension\guzzlehttp\guzzle\src\Event\EventInterface;
...
class EmitterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Event\EventInterface', $this->emitter->emit(self::preFoo, $this->getEvent()));
        $event = $this->getEvent();
    ...
    public function testAddSubscriberWithPriorities()
    {
        ...
        $this->assertNotEmpty($this->emitter->listeners(self::preFoo));
        $this->assertCount(2, $listeners);
        $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Tests\Event\TestEventSubscriberWithPriorities', $listeners[0][0]);
    }
    ...
    /**
     * @return \app\extension\guzzlehttp\guzzle\src\Event\EventInterface
     */
    private function getEvent()
    {
        return $this->getMockBuilder('app\extension\guzzlehttp\guzzle\src\Event\AbstractEvent')
