...
/**
 * @covers app\extension\guzzlehttp\guzzle\src\Event\RequestEvents
 */
    ...
    public function testBeforeSendEmitsErrorEvent()
    {
        ...
        $request->getEmitter()->on(
            ...
            function (ErrorEvent $e) use (&$errCalled, $response, $ex) {
                $errCalled++;
                $this->assertInstanceOf('app\extension\guzzlehttp\guzzle\src\Exception\RequestException', $e->getException());
