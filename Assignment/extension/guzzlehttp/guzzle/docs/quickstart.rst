...
API or using a ``app\extension\guzzlehttp\guzzle\src\ClientInterface`` object. Using the procedural API
...
.. code-block:: php
    ...
    $response = app\extension\guzzlehttp\guzzle\src\post('http://httpbin.org/post', [
        'headers' => ['X-Foo' => 'Bar'],
...
.. code-block:: php
    ...
    $response = app\extension\guzzlehttp\guzzle\src\head('http://httpbin.org/get');
    $response = app\extension\guzzlehttp\guzzle\src\post('http://httpbin.org/post');
    $response = app\extension\guzzlehttp\guzzle\src\put('http://httpbin.org/put');
    $response = app\extension\guzzlehttp\guzzle\src\delete('http://httpbin.org/delete');
    $response = app\extension\guzzlehttp\guzzle\src\options('http://httpbin.org/get');
...
then you'll need to use a ``app\extension\guzzlehttp\guzzle\src\ClientInterface`` object.
...
actually a ``app\extension\guzzlehttp\guzzle\src\Message\ResponseInterface`` object and contains lots
...
``app\extension\guzzlehttp\guzzle\src\Exception\ParseException`` is thrown.
...
``app\extension\guzzlehttp\guzzle\src\Query`` object as needed.
...
resource returned from ``fopen``, or a ``app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\StreamInterface``
...
.. code-block:: php
    ...
    // $postBody is an instance of app\extension\guzzlehttp\guzzle\src\Post\PostBodyInterface
...
``app\extension\app\extension\guzzlehttp\guzzle\src\streams\src\StreamInterface``, or
``app\extension\guzzlehttp\guzzle\src\Post\PostFileInterface`` objects.

.. code-block:: php

    use app\extension\guzzlehttp\guzzle\src\Post\PostFile;
...
- Set to a ``app\extension\guzzlehttp\guzzle\src\Subscriber\CookieJar\CookieJarInterface`` object to use
...
- In the event of a networking error (connection timeout, DNS errors, etc.),
  a ``app\extension\guzzlehttp\guzzle\src\Exception\RequestException`` is thrown. This exception
  extends from ``app\extension\guzzlehttp\guzzle\src\Exception\TransferException``. Catching this
...
- A ``app\extension\guzzlehttp\guzzle\src\Exception\ClientException`` is thrown for 400
  level errors if the ``exceptions`` request option is set to true. This
  exception extends from ``app\extension\guzzlehttp\guzzle\src\Exception\BadResponseException`` and
  ``app\extension\guzzlehttp\guzzle\src\Exception\BadResponseException`` extends from
  ``app\extension\guzzlehttp\guzzle\src\Exception\RequestException``.

  .. code-block:: php

      use app\extension\guzzlehttp\guzzle\src\Exception\ClientException;
...
- A ``app\extension\guzzlehttp\guzzle\src\Exception\ServerException`` is thrown for 500 level
  errors if the ``exceptions`` request option is set to true. This
  exception extends from ``app\extension\guzzlehttp\guzzle\src\Exception\BadResponseException``.
- A ``app\extension\guzzlehttp\guzzle\src\Exception\TooManyRedirectsException`` is thrown when too
  many redirects are followed. This exception extends from ``app\extension\guzzlehttp\guzzle\src\Exception\RequestException``.
- A ``app\extension\guzzlehttp\guzzle\src\Exception\AdapterException`` is thrown when an error occurs
