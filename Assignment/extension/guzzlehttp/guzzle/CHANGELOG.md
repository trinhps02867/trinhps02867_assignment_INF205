...
* Updating app\extension\guzzlehttp\guzzle\src/streams dependency to ~2.1
...
* Added `ToArrayInterface` to `app\extension\guzzlehttp\guzzle\src\Cookie\CookieJar`

4.1.0 (2014-05-27)
------------------

* Added a `json` request option to easily serialize JSON payloads.
* Added a `app\extension\guzzlehttp\guzzle\src\json_decode()` wrapper to safely parse JSON.
* Added `setPort()` and `getPort()` to `app\extension\guzzlehttp\guzzle\src\Message\RequestInterface`.
...
* Added `app\extension\guzzlehttp\guzzle\src\batch()` as a convenience function for sending requests in
  parallel without needing to write asynchronous code.
* Restructured how events are added to `app\extension\guzzlehttp\guzzle\src\ClientInterface::sendAll()`.
