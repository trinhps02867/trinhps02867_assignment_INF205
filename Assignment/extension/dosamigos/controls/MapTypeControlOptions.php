...
use app\extension\dosamigos\MapTypeId;
 ...
 *
 * ```
 * use app\extension\dosamigos\controls\MapTypeControlOptions;
 * use app\extension\dosamigos\controls\MapTypeControlStyle;
